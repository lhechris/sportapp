    ...
    <div class="flex flex-col lg:flex-row gap-4">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-body text-yellow-400 max-w-lg">
                <thead class="bg-black border-b border-default">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 font-bold">{{ __('Availability') }}</th>
                        <th scope="col" class="px-6 py-3 font-bold">{{ __('Selected') }}</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <div>
            <table class="text-sm text-left rtl:text-right text-body text-yellow-400 max-w-lg ">
                <thead class="bg-black border-b border-default">
                    <tr>
                        <th scope="col" class="px-6 py-3 font-bold">{{ __('Member') }}</th>
                        @foreach($options as $option)
                            <th scope="col" class="px-6 py-3 font-bold">{{ $option->label ?? ucfirst($option->name) }}</th>
                        @endforeach
                    </tr>
                </thead>
                <tbody>
